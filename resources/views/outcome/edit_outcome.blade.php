                    ...
                    <div class="clearfix visible-xs-block"></div>
                      <div style="margin-top: 150px;">
                        ...
                        @endif
										  ...
										  <form class="form-horizontal" action="{{ route('outcome.update', $outcome->id) }}" style="margin-left: 100px;" method="post">
                        ...
                        {!! csrf_field() !!}
										    ...
										    <div class="form-group">
										      ...
										      <div class="col-sm-10">
										        <input type="text" class="form-control" id="outcome_name" placeholder="Enter Outcome Name" name="outcome_name" style="width: 500px;" value="{{$outcome->outcome_name}}">
										      </div>
										    </div>
										    <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input type="date" id="date" class="form-control"  name="date" placeholder="DD/MM/YY" style="width: 500px;" value="{{$outcome->outcome_date}}" />
                          </div>
                        </div>
										     <div class="form-group">
